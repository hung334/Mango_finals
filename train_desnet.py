...
if __name__ == '__main__':
    ...
    #******************************************************************************************
    train_path="./datasets/unet_crop_Train"
    ...
    '''
    net.classifier = torch.nn.Sequential(torch.nn.Linear(1024, 3))
    ...
    loss_func = FocalLoss()#torch.nn.CrossEntropyLoss()
    ...
    for epoch in range(EPOCHS):
        ...
        with torch.no_grad():
            ...
            if(val_accuracy>=best_acc and train_accuracy>=best_train_acc):
